...
const obj = {
  ...
  secondParagraph: "mic mic mic cmichekc one two one two mic check mamamaaa micc check",
  thirdParagraph: "testing testing testin gtesting"
};
